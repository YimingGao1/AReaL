...
from view_suite.envs.scannet_proxy_task.vsi_bench_no_tool import VSIBenchNoToolGym
from view_suite.envs.scannet_proxy_task.vsi_bench_tool import VSIBenchTool
REGISTERED_ENVS = {
